...
export default function MobileEntryMultiDay({ currentUser }) {
  ...
  const form = useMobileForm({ isMultiDay: true, currentEmployee: data.currentEmployee });
  ...
  return (
    <div className="min-h-screen bg-slate-100">
      ...
      >
        ...
        {activeTab === "dienst" && <MobileDienstTab formData={form.formData} setFormData={form.setFormData} trips={form.trips} signature={form.signature} submittedTodayEntries={data.submittedTodayEntries} progressStep={form.progressStep} lastSavedAt={form.lastSavedAt} isSaving={form.isSaving} calculateHours={form.calculateHours} isMultiDay={true} isSubmitting={submit.isSubmitting} onSubmit={handleSubmitClick} onSaveDraft={async () => { await submit.handleSaveDraft(); setActiveTab("home"); }} setActiveTab={setActiveTab} />}
