...
import { Plus, Search, FileText, AlertTriangle, CheckCircle, Clock, Filter } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-slate-900">Documentenbeheer</h1>
          <p className="text-slate-500 mt-1">Centrale opslagplaats voor alle belangrijke documenten</p>
        </div>
