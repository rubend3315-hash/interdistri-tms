      ...
      json_schema: {
        ...
        items: {
          ...
          properties: {
            ...
            volledige_naam: { type: "string", description: "Volledige naam / Full name" },
            roepnaam: { type: "string", description: "Roepnaam / Nickname" },
            geboortenaam: { type: "string", description: "Geboortenaam / Birth name" },
            voorvoegsel: { type: "string", description: "Voorvoegsel / Prefix" },
