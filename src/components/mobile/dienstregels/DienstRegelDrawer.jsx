...
export default function DienstRegelDrawer({
  ...
  useEffect(() => {
    if (open && regel) {
      console.log('[DEBUG_TRACE] OPEN DRAWER regel:', JSON.stringify({ id: regel.id, type: regel.type, vehicle_id: regel.vehicle_id, customer_id: regel.customer_id, route_name: regel.route_name, start_time: regel.start_time, end_time: regel.end_time, _existingId: regel._existingId, openRit: regel.openRit, autoGenerated: regel.autoGenerated }));
      setDraft({ ...regel });
    }
  }, [open, regel?.id]);
