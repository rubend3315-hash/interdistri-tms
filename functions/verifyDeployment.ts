...
// Complete list of all backend functions
const ALL_FUNCTIONS = [
  'submitTimeEntry',
  ...
  'downloadDailyPayrollReportJson',
  'downloadDailyPayrollSchema',
  'generateDailyPayrollReport',
  'verifyDeployment',
  'addStarttijdToExisting',
  'analyzeContract',
  'checkEmployeeStatus',
  'cleanupOrphanTimeEntries',
  'clearTestDatabase',
  'deleteAllRapportageRits',
  'downloadContractPdf',
  'exportPDFToEmail',
  'exportTimeAndTrips',
  'fixRapportageKlantIds',
  'generatePerformanceReviewPDF',
  'generateReport',
  'generateSupabaseSQL',
  'generateSystemArchitecturePdf',
  'getContractForPdf',
  'getExcelColumns',
  'importFromSupabase',
  'importGmailHistory',
  ...
  'onContractActivated',
  'parseExcelImport',
  'processContractWijziging',
  'processPostNLImportToRapportage',
  'removeDuplicatePostNLImports',
  'removeDuplicates',
  'restoreBackup',
  'retryEmail',
  'scheduledSync',
  'sendContractReminders',
  'sendContractToPayroll',
  'testEmailSend',
  'testSignatureFetch',
  'testSignatureRender',
];
